...
const CODE_LANGUAGE_OPTIONS_PRISM = getCodeLanguageOptionsPrism().filter(
  (option) =>
    [
      "c",
      "clike",
...
const CODE_LANGUAGE_OPTIONS_SHIKI = getCodeLanguageOptionsShiki().filter(
  (option) =>
    [
      "c",
      "clike",
...
export default function ToolbarPlugin({
    ...
    if ($isNodeSelection(selection)) {
      ...
      for (const selectedNode of nodes) {
        ...
        if (parentList) {
          ...
          if (selectedElement.getFormatType) {
            updateToolbarState(
              "elementFormat",
  ...
  }, [activeEditor, editor, handleHeadingNode, handleCodeNode, updateToolbarState]);
  ...
  }, [editor, activeEditor, updateToolbar, updateToolbarState]);
