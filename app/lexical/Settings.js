    ...
    <>
      ...
      {showSettings ? (
        <div className="switches">
          ...
          <Switch onClick={() => setOption('showNestedEditorTreeView', !showNestedEditorTreeView)} checked={showNestedEditorTreeView} text="Nested Editors Debug View" />
          <Switch
            onClick={() => {
          ...
          <Switch onClick={() => setOption('hasLinkAttributes', !hasLinkAttributes)} checked={hasLinkAttributes} text="Link Attributes" />
          ...
          <Switch onClick={() => setOption('showTableOfContents', !showTableOfContents)} checked={showTableOfContents} text="Table Of Contents" />
          <Switch onClick={() => setOption('shouldUseLexicalContextMenu', !shouldUseLexicalContextMenu)} checked={shouldUseLexicalContextMenu} text="Use Lexical Context Menu" />
          <Switch onClick={() => setOption('shouldPreserveNewLinesInMarkdown', !shouldPreserveNewLinesInMarkdown)} checked={shouldPreserveNewLinesInMarkdown} text="Preserve newlines in Markdown" />
          <Switch onClick={() => setOption('shouldAllowHighlightingWithBrackets', !shouldAllowHighlightingWithBrackets)} checked={shouldAllowHighlightingWithBrackets} text="Use Brackets for Highlighting" />
          <Switch onClick={() => setOption('selectionAlwaysOnDisplay', !selectionAlwaysOnDisplay)} checked={selectionAlwaysOnDisplay} text="Retain selection" />
          <Switch onClick={() => setOption('isCodeHighlighted', !isCodeHighlighted)} checked={isCodeHighlighted} text="Enable Code Highlighting" />
          <Switch onClick={() => setOption('isCodeShiki', !isCodeShiki)} checked={isCodeShiki} text="Use Shiki for Code Highlighting" />
        </div>
      ) : null}
    </>
  );
